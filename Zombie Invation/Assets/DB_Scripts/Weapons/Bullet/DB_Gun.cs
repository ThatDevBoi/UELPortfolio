...
public class DB_Gun : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        backupAmmo = 90;                        // On Start Backup Ammo Always equals 90

        /// Audio 
        PC = GetComponent<AudioSource>();       // Find Audio Source on this gameObject
        PC.clip = Gun_ReloadPC;                 // Finding the reload audio clip that Audio Source can use 
        PC.clip = Gun_Shoot;                    // Finding the Shoot audio clip that Audio Source can use 
    } // ------------------------------------------------------------------------------------------------------------------------
